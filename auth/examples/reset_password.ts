 ...
 */
export async function askByEmail(email: string): Future<boolean> {
...
export async function askByPhone(phone: string): Future<boolean> {
 ...
 */
export async function confirmCode(phone: string, code: string): Future<string | null> {
 ...
 */
export async function fromLink(accountId: string, recoveryToken: string): Future<string | null> {
...
export async function finish(pendingToken: string, next: string, confirmation: string): Future<string | null> {
