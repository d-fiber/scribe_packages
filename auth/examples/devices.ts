 ...
 */
export function devicesOf(accountId: string): Future<{ device_id: string; model: string; trusted: boolean }[]> {
...
export async function lastSeen(accountId: string, deviceId: string): Future<string | null> {
...
export function kick(accountId: string, deviceId: string): Future<boolean> {
 ...
 */
export function kickAll(accountId: string): Future<void> {
