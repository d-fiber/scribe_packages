...
import { wholeMinutes } from "@scribe/host/packages/foundation/event_driven/cron/core/duration.ts";
import { nextRun } from "@scribe/host/packages/foundation/event_driven/cron/core/next_run.ts";
...
import type {
  ...
  Schedule,
  Scheduled,
} from "@scribe/host/packages/foundation/event_driven/cron/schedule.ts";
