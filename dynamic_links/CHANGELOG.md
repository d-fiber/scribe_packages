...
- [BREAKING]: lay dynamic_links out as package.yaml, lib and tests (aa7f04f)
- [BREAKING]: read a page through its own members (ae42e91)
...
- [DEV]: let a link route each visit, and declare its preview (e1ca339)
